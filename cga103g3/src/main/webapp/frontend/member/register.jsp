...
<table id="table-1">
	<tr><td>
		 <h3>註冊</h3></td><td>
		 <h4><a href="memberLoginIndex.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回登入頁面</a></h4>
	</td></tr>
</table>
...
<table>
	...
	<tr>
		...
		<td><input type="radio" name="memGender" size="45"
			 value="<%= (memberVO==null)? "M" : memberVO.getMemGender()%>" checked />男</td>
			<td><input type="radio" name="memGender" size="45"
			 value="<%= (memberVO==null)? "F" : memberVO.getMemGender()%>" />女</td>
