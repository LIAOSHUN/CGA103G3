	...
	<form id="form" METHOD="post" ACTION="member.do" name="form1"
		...
		<div class="card mb-4" style="width: 1000px; margin: 0 auto;">
			...
			<div class="card-body">
				...
				<div class="mb-3">
					<label for="memID" class="form-label"></label> <input id="memID"
						name="memID" type="hidden" class="form-control" autocomplete="off"
						value="<%=memberVO.getMemID()%>">
				</div>

			</div>
			<div class="mb-3">
				<label for="gradeID" class="form-label">會員等級</label> <input id="gradeID"
			...
			<div class="mb-3">
				<label for="PWD2" class="form-label">確認密碼:</label> <input id="PWD2"
					name="PWD2" type="password" class="form-control" autocomplete="off">
			</div>
			...
			<div class="mb-3">
				<label class="form-label">性別:</label> 男<input class="gender"
					...
					name="memGender" type="radio" autocomplete="off" value="F">
			</div>
