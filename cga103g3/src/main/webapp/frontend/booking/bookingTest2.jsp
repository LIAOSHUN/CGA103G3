...
<!-- 	==================================================== 圖片 ================================================================ -->
					<div class="row g-0">
                      ...
                      <div class="col-md-4">
                        <img class="card-img card-img-right" src="<%=request.getContextPath()%>/backend/images/tomcat.png" alt="Card image" width="200" height="250">
                      </div>
                    </div>
<!-- 	==================================================== 圖片 ================================================================ -->                  
...
<script src="<%=request.getContextPath()%>/frontend/booking/js/booking.js"></script>
</body>
