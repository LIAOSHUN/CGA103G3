		...
		<div class="card mb-4" style="width: 1000px; margin: 0 auto;">
			...
			<div class="mb-3">
					<label for="empAccount" class="form-label">帳號：</label> <input
						...
						autocomplete="off"
						 value="<%=employeeVO.getEmpAccount()%>">
				</div>
			...
			<div class="mb-3">
					<label for="empPassWord" class="form-label">密碼：</label> <input
						...
						autocomplete="off"
						 value="<%=employeeVO.getEmpPassWord()%>">
				</div>
			...
			<div class="mb-3">
				<label class="form-label">狀態:</label>啟用<input class="status"
					id="empStatus" name="empStatus" type="radio" autocomplete="off"
					value="1" checked> 停用<input class="gender" id="memGender"
					name="empStatus" type="radio" autocomplete="off" value="0">
			</div>
