...
<table>
	...
	<tr>
		<td>電話:</td>
		<td><input type="TEXT" name="empPhone" size="45"	value="<%=employeeVO.getEmpPhone()%>" /></td>
	</tr>

	<tr>
		<td>頭貼:</td>
		<td><input type="file" name="empAvatar" size="45"	value="<%=employeeVO.getEmpAvatar()%>" /></td>
		
	</tr>
	<tr>
		<td>帳號:</td>
		<td><input type="TEXT" name="empAccount" size="45" value="<%=employeeVO.getEmpAccount()%>" /></td>
	</tr>
	<tr>
		<td>密碼:</td>
		<td><input type="TEXT" name="empPassWord" size="45" value="<%=employeeVO.getEmpPassWord()%>" /></td>
	</tr>
	<tr>
		<td>雇用日期:</td>
	...
	<tr>
		<td>狀態:</td>
		<td><input type="TEXT" name="empStatus" size="45" value="<%=employeeVO.getEmpStatus()%>" /></td>
	</tr>
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=employeeVO.getEmpHireDate()%>', // value:   new Date(),
