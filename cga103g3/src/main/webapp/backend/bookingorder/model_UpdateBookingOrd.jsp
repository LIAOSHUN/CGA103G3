	...
	<ul>
		<c:forEach var="message" items="${errorMsgs}">
			<li style="color:red">${message}</li>
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header"><span class="text-muted fw-light">修改訂位訂單</span></h5>
                    <!-- Account -->
                   <form id="formAccountSettings" method="POST" ACTION="<%=request.getContextPath()%>/bookingorder/bookingorder.do">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="bookingID" class="form-label">訂位訂單編號</label>
                            <input
                              class="form-control"
                              type="text"
                              id="bookingID"
                              name="bookingID"
                              value="<%=bokOrdVO.getBookingID() %>"
                            readonly/>
                          </div>
                          ...
                          <jsp:useBean id="boxSvc" scope="page" class="com.box.model.BoxService" />
                           <div class="mb-3 col-md-6">
                            ...
                            <select name="boxID" id="boxID" class="select2 form-select">
                            	<option value="<%=bokOrdVO.getBoxID() %>" selected="selected" hidden><%=bokOrdVO.getBoxID() %></option>
                              <c:forEach var="boxVO" items="${boxSvc.all}"> 
								<option value="${boxVO.boxID}" >[ ${boxVO.storeID}門市 ] - ${boxVO.boxID} / ${boxVO.boxDescription}</option>
							  </c:forEach>
                            </select>
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                        	  ...
                        	  <div class="col-md-10">
                          		<input class="form-control" type="date" name="bookingDate" value="<%=bokOrdVO.getBookingDate() %>" id="bookingDate">
                        	  </div>
                     	 </div>
                         ...
                         <div class="mb-3 col-md-6">
                          ...
                          <div>
                        	<label for="bookingNote" class="form-label">預約備註</label>
                       		<textarea name="bookingNote" class="form-control" id="bookingNote" rows="3"><%=bokOrdVO.getBookingNote() %></textarea>
                      	  </div>
                      	  
                      	 <div class="mb-3 col-md-6">
                            <label for="bookingStatus" class="form-label">預約狀態</label>
                            <select name="bookingStatus" id="bookingStatus" class="select2 form-select">
                              <option value="<%=bokOrdVO.getBookingStatus() %>" selected="selected" hidden><%=(bokOrdVO.getBookingStatus() == 1)? "訂位成功":"訂位取消" %></option>
                              <option value="0">訂位結束</option>
                              <option value="1">訂位成功</option>
                            </select>
                          </div>

                        </div>
                        <div class="mt-2">
                          <input type="hidden" name="action" value="update_BookingOrder">
