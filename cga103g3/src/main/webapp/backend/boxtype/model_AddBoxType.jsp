	...
	<ul>
		<c:forEach var="message" items="${errorMsgs}">
			<li style="color:red">${message}</li>
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header"><span class="text-muted fw-light">新增包廂類型</span></h5>
                    <!-- Account -->
                    ...
                    <div class="card-body">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            <label name="boxName" for="boxName" class="form-label">包廂類型</label>
								<input style="width: 150px"
                              		class="form-control"
                             		type="text"
                              		id="boxName"
                              		name="boxName"
                              		value="<%= (btVO==null)? "" : btVO.getBoxName() %>"
                            	/>
                          </div>
