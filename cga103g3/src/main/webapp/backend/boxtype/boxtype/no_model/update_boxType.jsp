<%@page import="com.boxtype.model.BoxTypeVO"%>
...
<title>包型類型修改 - update_boxType.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>包型類型修改 - update_boxType.jsp</h3>
...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/boxtype/boxtype.do" name="form1">
<table>
	<tr>
		<td>包廂類型編號:<font color=red><b>*</b></font></td>
		<td><%=btVO.getBoxTypeID()%></td>
	</tr>
	<tr>
		<td>包廂類型名稱:</td>
		<td><input type="text" name="boxName" size="9" value="<%=btVO.getBoxName()%>">
	</tr>
