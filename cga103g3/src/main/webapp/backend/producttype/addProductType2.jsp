	...
	<div class="layout-wrapper layout-content-navbar">
		<div class="layout-container">
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item "><a href="javascript:void(0);"
						...
						<ul class="menu-sub">
							...
							<li class="menu-item"><a
								href="pages-account-settings-account.html" class="menu-link">
									<div data-i18n="Account">所有商品</div>
							</a></li>
							<li class="menu-item"><a
					...
					<li class="menu-item active open"><a
						href="javascript:void(0);" class="menu-link menu-toggle"> <i
							...
							<div data-i18n="Account Settings">遊戲種類管理</div>
					</a>
						<ul class="menu-sub">
							<li class="menu-item active"><a href="addProductType2.jsp"
								class="menu-link">
									<div data-i18n="Account">新增遊戲種類</div>
							</a></li>
							<li class="menu-item"><a
								href="pages-account-settings-account.html" class="menu-link">
									<div data-i18n="Account">修改遊戲種類</div>
							</a></li>
							<li class="menu-item"><a
								href="pages-account-settings-account.html" class="menu-link">
									<div data-i18n="Account">所有遊戲種類</div>
							</a></li>
						</ul></li>
					<!-- ======================================================================================================= -->
					<li class="menu-item"><a href="javascript:void(0);"
			...
			<div class="layout-page">
				...
				<FORM METHOD="post"
					ACTION="/cga103g3/producttype/ProductTypeServlet" name="form1">
					<div class="content-wrapper">
						...
						<div class="container-xxl flex-grow-1 container-p-y">
							...
							<div class="row">
								...
								<div style="width: 100%">
									<div class="card mb-4">
										<h5 class="card-header">新增遊戲種類</h5>
										<div class="card-body demo-vertical-spacing demo-only-element">
											<div class="input-group">
												<span class="input-group-text" id="basic-addon11">種類名稱</span>
												<input type="text" class="form-control"
													placeholder="Username" aria-label="Username"
													aria-describedby="basic-addon11" name="pdTypeName"
													value="<%= (productTypeVO==null)? "測試種類" : productTypeVO.getPdTypeName()%>" />
											</div>
