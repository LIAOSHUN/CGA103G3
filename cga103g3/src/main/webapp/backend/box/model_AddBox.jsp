	...
	<ul>
		<c:forEach var="message" items="${errorMsgs}">
			<li style="color:red">${message}</li>
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header"><span class="text-muted fw-light">新增包廂</span></h5>
                    <!-- Account -->
                   <form id="formAccountSettings" method="POST" ACTION="<%=request.getContextPath()%>/box/box.do" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <jsp:useBean id="storeSvc" scope="page" class="com.store.model.StoreService" />
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="boxTypeID" class="form-label">包廂類型</label>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <textarea
                              ...
                              name="boxDescription"
                              autocomplete="off"
                            ><%= (boxVO==null)? "" : boxVO.getBoxDescription()%></textarea>
                          </div>
