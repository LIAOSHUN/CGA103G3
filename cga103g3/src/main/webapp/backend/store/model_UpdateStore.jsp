	...
	<ul>
		<c:forEach var="message" items="${errorMsgs}">
			<li style="color:red">${message}</li>
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header"><span class="text-muted fw-light"><b><%=stVO.getStoreName() %> /</b></span>門市資訊更改</h5>
                    <!-- Account -->
                   <form id="formAccountSettings" method="POST" ACTION="<%=request.getContextPath()%>/store/store.do" enctype="multipart/form-data">
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          class="show"
                          src="<%=request.getContextPath()%>/StoreImg?StoreID=${stVO.storeID}"
                          height="150"
                          width="150"
                        />
                        <div>
                    ...
                    <div class="card-body">
                        <div class="row">
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" value="<%=stVO.getStoreID()%>" readonly />
                          </div>
                          
                           <div class="mb-3 col-md-6">
                            <label for="storeName" class="form-label">門市店名</label>
                            <input
                              class="form-control"
                              type="text"
                              id="storeName"
                              name="storeName"
                              value="<%=stVO.getStoreName()%>"
                            />
                          </div>
                          
                          <div class="mb-3 col-md-6">
                            <label for="storeAdd" class="form-label">門市地址</label>
                            <input
                              class="form-control"
                              type="text"
                              id="storeAdd"
                              name="storeAdd"
                              value="<%=stVO.getStoreAdd()%>"
                            />
                          </div>
                          
                          <div class="mb-3 col-md-6">
                            <label for="storePhone1" class="form-label">門市電話1</label>
                            <input
                              class="form-control"
                              type="text"
                              id="storePhone1"
                              name="storePhone1"
                              value="<%=stVO.getStorePhone1()%>"
                            />
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select name="storeOpen" id="storeOpen" class="select2 form-select">
                              <option value="<%=stVO.getStoreOpen() %>" selected="selected" hidden><%=stVO.getStoreOpen() %>:00</option>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <option value="<%=stVO.getStoreClose() %>" selected="selected" hidden><%=stVO.getStoreClose() %>:00</option>
                              <option value="0">00:00</option>
                              <option value="1">01:00</option>
                              <option value="2">02:00</option>
                              <option value="3">03:00</option>
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="empID" class="form-label">門市管理員</label>
                            <input
                              class="form-control"
                              type="text"
                              id="empID"
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select name="storeStatus" id="storeStatus" class="select2 form-select">
                            <option value="<%=stVO.getStoreStatus() %>" selected="selected" hidden><%= (stVO.getStoreStatus()==0)? "營業":"歇業" %></option>
