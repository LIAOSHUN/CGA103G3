...
<!-- ============================================ < Content內容 > ======================================================= -->
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">門市 /</span> Store Information</h4>
<a class="btn rounded-pill btn-outline-success" href='<%=request.getContextPath()%>/backend/store/model_AddStore.jsp' role="button" aria-expanded="false" aria-controls="collapseExample"><b>新增門市</b></a>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">門市表</h5>
...
<%--                         <td>${storeVO.storeID}</td> --%>
                        <td>${storeVO.storeID}<br>${storeVO.storeName}</td>
<%--                         <td>${storeVO.storeAdd}</td> --%>
<%--                         <td>${storeVO.storePhone1}</td> --%>
                        <td>${storeVO.storePhone1}<br>${storeVO.storePhone2}</td>
                        <td>${storeVO.storeAdd}<br>${storeVO.storeEmail}</td>
