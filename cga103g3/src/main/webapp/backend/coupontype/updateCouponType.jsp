        ...
        <div class="layout-page">
          ...
          >
			...
			<div class="container-xxl flex-grow-1 container-p-y">
						<div class="card">
							<h2 class="card-header">優惠券修改</h2>
			 				<div id="backmagOrderList">
								<button class="btn btn-outline-primary"  onclick="location.href='listAllCouponType.jsp'"> 回上頁</button>
							</div>
							...
							<table>
								...
								<tr>
									<td>優惠券名稱:</td>
									<td><input type="TEXT" name="coupName" size="45" autofocus value="<%=couponTypeVO.getCoupName()%>" /></td>
								</tr>
								<tr>
									<td>折價價格:</td>
									<td><input type="TEXT" name="coupDiscount" size="45" value="<%=couponTypeVO.getCoupDiscount()%>" /></td>
								</tr>
								<tr>
									<td>數量:</td>
									<td><input type="TEXT" name="coupQuantity" size="45" value="<%=couponTypeVO.getCoupQuantity()%>" /></td>
								</tr>
							
								
								<tr>
									<td>優惠券狀態:</td>
									<td><select size="1" name="coupUpd">
...
<!-- 								<tr> -->
<!-- 									<td>開始發放時間:</td> -->
<%-- 									<td><input name="coupStart" value="<%=couponTypeVO.getCoupStart()%>" type="text" disabled ></td> --%>
<!-- 								</tr> -->
<!-- 								<tr> -->
<!-- 									<td>結束發放時間:</td> -->
<%-- 									<td><input name="coupEnd" value="<%=couponTypeVO.getCoupEnd()%>" type="text" disabled ></td> --%>
<!-- 								</tr> -->
							
								<tr>
									<td>描述:</td>
									<td><textarea style="width:420px;height:100px;" name="coupDesc" /><%=couponTypeVO.getCoupDesc()%></textarea>
									</td>
								</tr>
							...
							<input type="hidden" name="coupTypeNo" value="<%=couponTypeVO.getCoupTypeNo()%>">
							<div id="updatebutton">
...
<style>
  ...
  .xdsoft_datetimepicker .xdsoft_timepicker .xdsoft_time_box {
           height: 151px !important;   /* height:  151px; */
  }
</style>
